...
class Term::ANSIColor::RGBColorMetrics::YUV::YUVTriple < Anonymous_Struct_30
...
class Term::ANSIColor::RGBColorMetrics::CIEXYZ::CIEXYZTriple < Anonymous_Struct_31
  def self.from_rgb_triple(rgb_triple); end
...
class Term::ANSIColor::RGBColorMetrics::CIELab::CIELabTriple < Anonymous_Struct_32
  def self.from_rgb_triple(rgb_triple); end
  extend Term::ANSIColor::RGBColorMetricsHelpers::NormalizeRGBTriple
  include Term::ANSIColor::RGBColorMetricsHelpers::WeightedEuclideanDistance
end
