...
# source://jeweler//lib/jeweler/generator.rb#19
class Jeweler::FileInTheWay < ::StandardError; end
...
#
# source://jeweler//lib/jeweler/generator.rb#31
class Jeweler::Generator
  # @raise [NoGitUserName]
  # @return [Generator] a new instance of Generator
  #
  # source://jeweler//lib/jeweler/generator.rb#60
  def initialize(options = T.unsafe(nil)); end

  # source://jeweler//lib/jeweler/generator.rb#137
  def constant_name; end

  # Returns the value of attribute description.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def description; end
  ...
  # Sets the attribute development_dependencies
  #
  # @param value the value to set the attribute development_dependencies to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def development_dependencies=(_arg0); end
  ...
  # Sets the attribute documentation_framework
  #
  # @param value the value to set the attribute documentation_framework to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def documentation_framework=(_arg0); end

  # source://jeweler//lib/jeweler/generator.rb#157
  def feature_filename; end

  # source://jeweler//lib/jeweler/generator.rb#165
  def features_dir; end

  # source://jeweler//lib/jeweler/generator.rb#173
  def features_steps_dir; end

  # source://jeweler//lib/jeweler/generator.rb#169
  def features_support_dir; end

  # source://jeweler//lib/jeweler/generator.rb#149
  ...
  #
  # @param value the value to set the attribute git_remote to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def git_remote=(_arg0); end
  ...
  # Sets the attribute github_username
  #
  # @param value the value to set the attribute github_username to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def github_username=(_arg0); end
  ...
  #
  # @param value the value to set the attribute homepage to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def homepage=(_arg0); end

  # source://jeweler//lib/jeweler/generator.rb#153
  def lib_dir; end

  # source://jeweler//lib/jeweler/generator.rb#141
  ...
  # Sets the attribute project_name
  #
  # @param value the value to set the attribute project_name to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def project_name=(_arg0); end
  ...
  # source://jeweler//lib/jeweler/generator.rb#145
  def require_name; end

  # source://jeweler//lib/jeweler/generator.rb#127
  def run; end
  ...
  # Sets the attribute should_create_remote_repo
  #
  # @param value the value to set the attribute should_create_remote_repo to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def should_create_remote_repo=(_arg0); end
  ...
  # Sets the attribute should_setup_rubyforge
  #
  # @param value the value to set the attribute should_setup_rubyforge to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def should_setup_rubyforge=(_arg0); end
  ...
  # Sets the attribute should_use_bundler
  #
  # @param value the value to set the attribute should_use_bundler to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def should_use_bundler=(_arg0); end
  ...
  # Sets the attribute should_use_cucumber
  #
  # @param value the value to set the attribute should_use_cucumber to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def should_use_cucumber=(_arg0); end
  ...
  # Sets the attribute should_use_reek
  #
  # @param value the value to set the attribute should_use_reek to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def should_use_reek=(_arg0); end
  ...
  # Sets the attribute should_use_roodi
  #
  # @param value the value to set the attribute should_use_roodi to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def should_use_roodi=(_arg0); end

  # source://jeweler//lib/jeweler/generator.rb#161
  ...
  # Sets the attribute target_dir
  #
  # @param value the value to set the attribute target_dir to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def target_dir=(_arg0); end
  ...
  # Sets the attribute testing_framework
  #
  # @param value the value to set the attribute testing_framework to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  def testing_framework=(_arg0); end
  ...
  #
  # @param value the value to set the attribute user_email to.
  #
  # source://jeweler//lib/jeweler/generator.rb#50
  ...
  # source://jeweler//lib/jeweler/generator.rb#285
  def create_and_push_repo; end

  # source://jeweler//lib/jeweler/generator.rb#179
  def create_files; end

  # source://jeweler//lib/jeweler/generator.rb#255
  def create_version_control; end

  # source://jeweler//lib/jeweler/generator.rb#241
  def mkdir_in_target(directory); end

  # source://jeweler//lib/jeweler/generator.rb#228
  def output_template_in_target(source, destination = T.unsafe(nil)); end

  # source://jeweler//lib/jeweler/generator.rb#220
  def render_template(source); end

  # source://jeweler//lib/jeweler/generator.rb#237
  def template_dir; end

  # source://jeweler//lib/jeweler/generator.rb#249
  def touch_in_target(destination); end
end

# source://jeweler//lib/jeweler/generator/application.rb#5
class Jeweler::Generator::Application
  extend ::Shellwords

  class << self
    # source://jeweler//lib/jeweler/generator/application.rb#51
    def build_options(arguments); end

    # source://jeweler//lib/jeweler/generator/application.rb#9
    def run!(*arguments); end
  end
end

# source://jeweler//lib/jeweler/generator/bacon_mixin.rb#3
module Jeweler::Generator::BaconMixin
  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/bacon_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/github_mixin.rb#3
module Jeweler::Generator::GithubMixin
  # source://jeweler//lib/jeweler/generator/github_mixin.rb#11
  def git_remote; end

  # source://jeweler//lib/jeweler/generator/github_mixin.rb#15
  def homepage; end
  ...
  class << self
    ...
    # @raise [NoGitHubUser]
    #
    # source://jeweler//lib/jeweler/generator/github_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#3
module Jeweler::Generator::MicronautMixin
  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/micronaut_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/minitest_mixin.rb#3
module Jeweler::Generator::MinitestMixin
  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/minitest_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/options.rb#3
class Jeweler::Generator::Options < ::Hash
  # @return [Options] a new instance of Options
  #
  # source://jeweler//lib/jeweler/generator/options.rb#6
  def initialize(args); end

  # source://jeweler//lib/jeweler/generator/options.rb#163
  def git_config; end

  # source://jeweler//lib/jeweler/generator/options.rb#150
  def merge(other); end

  # Returns the value of attribute opts.
  #
  # source://jeweler//lib/jeweler/generator/options.rb#4
  def opts; end
  ...
  class << self
    ...
    #
    # source://jeweler//lib/jeweler/generator/options.rb#155
    def git_config; end
  end
end

# source://jeweler//lib/jeweler/generator/rdoc_mixin.rb#3
module Jeweler::Generator::RdocMixin
  # source://jeweler//lib/jeweler/generator/rdoc_mixin.rb#8
  def doc_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/rdoc_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/riot_mixin.rb#3
module Jeweler::Generator::RiotMixin
  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/riot_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/riot_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/rspec_mixin.rb#3
module Jeweler::Generator::RspecMixin
  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/rspec_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/shindo_mixin.rb#3
module Jeweler::Generator::ShindoMixin
  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#17
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#22
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#34
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#38
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#30
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#26
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/shindo_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#3
module Jeweler::Generator::ShouldaMixin
  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/shoulda_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/testspec_mixin.rb#3
module Jeweler::Generator::TestspecMixin
  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#8
  def default_task; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#16
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#12
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#20
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#32
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#36
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#28
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#24
  def test_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/testspec_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator/testunit_mixin.rb#3
module Jeweler::Generator::TestunitMixin
  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#4
  def default_task; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#12
  def feature_support_extend; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#8
  def feature_support_require; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#16
  def test_dir; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#28
  def test_filename; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#32
  def test_helper_filename; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#24
  def test_pattern; end

  # source://jeweler//lib/jeweler/generator/testunit_mixin.rb#20
  def test_task; end
end

# source://jeweler//lib/jeweler/generator/yard_mixin.rb#3
module Jeweler::Generator::YardMixin
  # source://jeweler//lib/jeweler/generator/yard_mixin.rb#9
  def doc_task; end

  class << self
    # @private
    #
    # source://jeweler//lib/jeweler/generator/yard_mixin.rb#4
    def extended(generator); end
  end
end

# source://jeweler//lib/jeweler/generator.rb#25
class Jeweler::GitInitFailed < ::StandardError; end

# source://jeweler//lib/jeweler/generator.rb#27
class Jeweler::GitRepoCreationFailed < ::StandardError; end

# source://jeweler//lib/jeweler/generator.rb#21
class Jeweler::NoGitHubRepoNameGiven < ::StandardError; end

# source://jeweler//lib/jeweler/generator.rb#23
class Jeweler::NoGitHubUser < ::StandardError; end

# source://jeweler//lib/jeweler/generator.rb#17
class Jeweler::NoGitUserEmail < ::StandardError; end

# source://jeweler//lib/jeweler/generator.rb#15
class Jeweler::NoGitUserName < ::StandardError; end
