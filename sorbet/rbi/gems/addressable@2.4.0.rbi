...
#
# source://addressable//lib/addressable/version.rb#21
module Addressable; end

# source://addressable//lib/addressable/idna/pure.rb#20
module Addressable::IDNA
  class << self
    # Converts from a Unicode internationalized domain name to an ASCII
    # domain name as described in RFC 3490.
    #
    # source://addressable//lib/addressable/idna/pure.rb#66
    def to_ascii(input); end

    # Converts from an ASCII domain name to a Unicode internationalized
    # domain name as described in RFC 3490.
    #
    # source://addressable//lib/addressable/idna/pure.rb#92
    def to_unicode(input); end

    # Unicode normalization form KC.
    #
    # source://addressable//lib/addressable/idna/pure.rb#110
    def unicode_normalize_kc(input); end

    private

    # source://addressable//lib/addressable/idna/pure.rb#277
    def lookup_unicode_combining_class(codepoint); end

    # source://addressable//lib/addressable/idna/pure.rb#285
    def lookup_unicode_compatibility(codepoint); end

    # source://addressable//lib/addressable/idna/pure.rb#300
    def lookup_unicode_composition(unpacked); end

    # source://addressable//lib/addressable/idna/pure.rb#292
    def lookup_unicode_lowercase(codepoint); end

    # Bias adaptation method
    #
    # source://addressable//lib/addressable/idna/pure.rb#655
    def punycode_adapt(delta, numpoints, firsttime); end

    # @return [Boolean]
    #
    # source://addressable//lib/addressable/idna/pure.rb#623
    def punycode_basic?(codepoint); end

    # source://addressable//lib/addressable/idna/pure.rb#501
    ...
    #
    # source://addressable//lib/addressable/idna/pure.rb#641
    ...
    # source://addressable//lib/addressable/idna/pure.rb#133
    def unicode_compose(unpacked); end

    # source://addressable//lib/addressable/idna/pure.rb#161
    def unicode_compose_pair(ch_one, ch_two); end

    # source://addressable//lib/addressable/idna/pure.rb#239
    def unicode_decompose(unpacked); end

    # source://addressable//lib/addressable/idna/pure.rb#260
    ...
    #
    # source://addressable//lib/addressable/idna/pure.rb#125
    def unicode_downcase(input); end

    # source://addressable//lib/addressable/idna/pure.rb#215
    def unicode_sort_canonical(unpacked); end
  end
end

# source://addressable//lib/addressable/idna/pure.rb#350
Addressable::IDNA::ACE_MAX_LENGTH = T.let(T.unsafe(nil), Integer)

# source://addressable//lib/addressable/idna/pure.rb#39
Addressable::IDNA::ACE_PREFIX = T.let(T.unsafe(nil), String)

# source://addressable//lib/addressable/idna/pure.rb#339
...
# source://addressable//lib/addressable/idna/pure.rb#307
...
# source://addressable//lib/addressable/idna/pure.rb#308
...
# source://addressable//lib/addressable/idna/pure.rb#352
...
# Input is invalid.
#
# source://addressable//lib/addressable/idna/pure.rb#374
class Addressable::IDNA::PunycodeBadInput < ::StandardError; end

# Output would exceed the space provided.
#
# source://addressable//lib/addressable/idna/pure.rb#376
...
# source://addressable//lib/addressable/idna/pure.rb#330
...
# source://addressable//lib/addressable/idna/pure.rb#349
...
# source://addressable//lib/addressable/idna/pure.rb#52
...
#
# source://addressable//lib/addressable/uri.rb#29
class Addressable::URI
  ...
  #
  # source://addressable//lib/addressable/uri.rb#777
  ...
  #   otherwise.
  #
  # source://addressable//lib/addressable/uri.rb#2140
  def ==(uri); end
  ...
  #   otherwise.
  #
  # source://addressable//lib/addressable/uri.rb#2118
  def ===(uri); end
  ...
  #   otherwise.
  #
  # source://addressable//lib/addressable/uri.rb#1780
  def absolute?; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1152
  def authority; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1189
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1498
  def basename; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1371
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2299
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2102
  def display_uri; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2172
  def dup; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2234
  def empty?; end
  ...
  #   otherwise.
  #
  # source://addressable//lib/addressable/uri.rb#2154
  def eql?(uri); end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1508
  def extname; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1736
  ...
  #
  # source://addressable//lib/addressable/uri.rb#814
  def freeze; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1060
  def host; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1093
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1123
  def hostname; end
  ...
  # @see Addressable::URI#host=
  #
  # source://addressable//lib/addressable/uri.rb#1135
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1357
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2287
  def inspect; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1756
  def ip_based?; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1893
  def join!(uri); end
  ...
  # @see Hash#merge
  #
  # source://addressable//lib/addressable/uri.rb#1908
  def merge(hash); end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1973
  def merge!(uri); end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2091
  def normalize!; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1170
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1720
  ...
  #
  # source://addressable//lib/addressable/uri.rb#946
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1451
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1309
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1525
  ...
  #
  # source://addressable//lib/addressable/uri.rb#842
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1402
  ...
  #
  # source://addressable//lib/addressable/uri.rb#892
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1011
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2198
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2225
  def omit!(*components); end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1229
  def origin; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1248
  ...
  #
  # source://addressable//lib/addressable/uri.rb#938
  def password; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1442
  def path; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1480
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1301
  def port; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1325
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1545
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1576
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1625
  ...
  #   otherwise.
  #
  # source://addressable//lib/addressable/uri.rb#1770
  def relative?; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1676
  def request_uri; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1986
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2051
  ...
  #
  # source://addressable//lib/addressable/uri.rb#834
  def scheme; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#860
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1384
  def site; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2270
  def to_hash; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#884
  def user; end
  ...
  #
  # source://addressable//lib/addressable/uri.rb#912
  ...
  #
  # source://addressable//lib/addressable/uri.rb#1031
  ...
  #
  # source://addressable//lib/addressable/uri.rb#2409
  ...
  class << self
    ...
    #   scheme was provided.
    #
    # source://addressable//lib/addressable/uri.rb#245
    ...
    #   parameter.
    #
    # source://addressable//lib/addressable/uri.rb#562
    ...
    #
    # source://addressable//lib/addressable/uri.rb#345
    ...
    #
    # source://addressable//lib/addressable/uri.rb#687
    ...
    #
    # source://addressable//lib/addressable/uri.rb#161
    ...
    # @return [Addressable::URI] The joined URI.
    #
    # source://addressable//lib/addressable/uri.rb#296
    def join(*uris); end
    ...
    #
    # source://addressable//lib/addressable/uri.rb#497
    ...
    #
    # source://addressable//lib/addressable/uri.rb#2323
    ...
    #   parameter.
    #
    # source://addressable//lib/addressable/uri.rb#617
    ...
    #
    # source://addressable//lib/addressable/uri.rb#1291
    ...
    #   parameter.
    #
    # source://addressable//lib/addressable/uri.rb#415
...
# <a href="http://www.ietf.org/rfc/rfc3986.txt">RFC 3986</a>.
#
# source://addressable//lib/addressable/uri.rb#38
module Addressable::URI::CharacterClasses; end

# source://addressable//lib/addressable/uri.rb#39
...
# source://addressable//lib/addressable/uri.rb#40
...
# source://addressable//lib/addressable/uri.rb#1446
Addressable::URI::NORMPATH = T.let(T.unsafe(nil), Regexp)

# source://addressable//lib/addressable/uri.rb#2310
...
# source://addressable//lib/addressable/uri.rb#2312
...
# source://addressable//lib/addressable/uri.rb#2314
Addressable::URI::RULE_2D = T.let(T.unsafe(nil), Regexp)

# source://addressable//lib/addressable/uri.rb#2315
Addressable::URI::RULE_PREFIXED_PARENT = T.let(T.unsafe(nil), Regexp)

# source://addressable//lib/addressable/uri.rb#2309
