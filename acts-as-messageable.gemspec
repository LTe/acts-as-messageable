...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('ancestry'.freeze, ['>= 0'])
  s.add_runtime_dependency('railties'.freeze, ['>= 0'])
  s.add_runtime_dependency('sorbet-rails'.freeze, ['>= 0'])
  s.add_runtime_dependency('sorbet-static-and-runtime'.freeze, ['>= 0'])
  s.add_development_dependency('appraisal'.freeze, ['>= 0'])
  s.add_development_dependency('coveralls_reborn'.freeze, ['>= 0'])
  ...
  s.add_development_dependency('rubocop-sorbet'.freeze, ['>= 0'])
  s.add_development_dependency('sord'.freeze, ['>= 0'])
  s.add_development_dependency('sqlite3'.freeze, ['>= 0'])
  s.add_development_dependency('tapioca'.freeze, ['>= 0'])
  s.add_development_dependency('timecop'.freeze, ['>= 0'])
  s.add_development_dependency('unparser'.freeze, ['>= 0'])
